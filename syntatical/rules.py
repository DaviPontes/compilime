...
E_OR_RULE = 13 #E E || L
E_L_RULE = 14 #E L
L_LESS_RULE = 33 #L L < R
L_GREATER_RULE = 34 #L L > R
...
Y_F_RULE = 81 #Y F
F_LV_RULE = 15 #F LV
F_PLUS_PLUS_RULE = 16 #F ++ LV
F_MINUS_MINUS_RULE = 17 #F -- LV
F_LV_PLUS_PLUS_RULE = 18 #F LV ++
F_LV_MINUS_MINUS_RULE = 19 #F LV --
F_E_RULE = 20 #F ( E )
F_IDU_RULE = 21 #F IDU MC ( LE )
